		...
		foreach ( $sites as $site ) :
			...
			elseif ( 'facebook' == $site ) { ?>
				...
				<li class="share-facebook">
					<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo rawurlencode( esc_url( $url ) ); ?>" title="<?php esc_html_e( 'Share on Facebook', 'total' ); ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" rel="nofollow">
			...
			elseif ( 'google_plus' == $site ) { ?>
				...
				<li class="share-googleplus">
					<a href="https://plus.google.com/share?url=<?php echo rawurlencode( esc_url( $url ) ); ?>" title="<?php esc_html_e( 'Share on Google+', 'total' ); ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" rel="nofollow">
			...
			elseif ( 'email' == $site ) { ?>
				...
				<li class="share-email">
					<a href="mailto:?subject=<?php echo rawurlencode( $title); ?>&amp;body=Check it out here <?php echo rawurlencode( esc_url( $url ) ); ?>" title="<?php esc_html_e( 'Send via email', 'total' ); ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" rel="nofollow">
						<span class="fa fa-envelope" aria-hidden="true"></span>
						<span class="social-share-button-text"><?php esc_html_e( 'Email', 'total' ); ?></span>
					</a>
				</li>
