...
function wpex_cac_has_background_image() {
	return get_theme_mod( 't_background_image' ) ? true : false;
}

function wpex_cac_hasnt_background_image() {
	return get_theme_mod( 't_background_image' ) ? false : true;
}

function wpex_cac_hasnt_background_pattern() {
	return get_theme_mod( 't_background_pattern' ) ? false : true;
}
...
function wpex_cac_header_supports_fixed_header() {
	...
	return ( 'one' == $header_style || 'five' == $header_style ) ? true : false;
}
...
function wpex_cac_has_vertical_header() {
	return ( 'six' == get_theme_mod( 'header_style' ) ) ? true : false;
}
...
function wpex_ca_has_header_two() {
	return ( 'two' == get_theme_mod( 'header_style', 'one'  ) ) ? true : false;
}
