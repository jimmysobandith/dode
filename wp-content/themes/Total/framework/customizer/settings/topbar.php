...
$this->sections['wpex_topbar_content'] = array(
	...
	'settings' => array(
		array(
			'id' => 'top_bar_content',
			'transport' => 'partialRefresh',
			'default' => '[font_awesome icon="phone" margin_right="5px"] 1-800-987-654 [font_awesome icon="envelope" margin_right="5px" margin_left="20px"] admin@totalwptheme.com [font_awesome icon="user" margin_right="5px" margin_left="20px"] [wp_login_url text="User Login" logout_text="Logout"]',
			'control' => array(
