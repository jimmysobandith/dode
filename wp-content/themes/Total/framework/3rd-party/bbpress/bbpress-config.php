...
if ( ! class_exists( 'WPEX_BBpress_Config' ) ) {
	...
	class WPEX_BBpress_Config {
		...
		public function __construct() {
			...
			add_action( 'wp_enqueue_scripts', array( 'WPEX_BBpress_Config', 'scripts' ), 10 );
			...
			// Accents
			add_filter( 'wpex_accent_texts', array( 'WPEX_BBpress_Config', 'accent_texts' ), 10 );
			add_filter( 'wpex_accent_backgrounds', array( 'WPEX_BBpress_Config', 'accent_backgrounds' ), 10 );

			// Add Customizer panel
			add_filter( 'wpex_customizer_panels', array( 'WPEX_BBpress_Config', 'add_customizer_panel' ), 10 );

			// Add to localize array
			add_filter( 'wpex_localize_array', array( 'WPEX_BBpress_Config', 'localize_array' ), 10 );
		 ...
		 * @since 4.5.4
		 */
		public static function localize_array( $settings ) {
